...
# We may need to clean up the data a bit if there are typos or annotations with no species

# Setting 'Species' to be a factor - this can be helpful down the line
anot$Species <- as.factor(anot$Species)

# Dropping rows with no species detections
...
all.files.hourSummary[1, 1] = '24' # changes midnight from 0 to 24
